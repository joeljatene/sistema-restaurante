...
# --- 1. CONFIGURAÇÃO ---
st.set_page_config(page_title="Sistema Restaurante V6.1", layout="wide", page_icon="🥘")
...
def gerar_pdf(df):
    ...
    # Definindo larguras: Produto(60), Qtd(25), Unid(15), Validade(25), Total(30), Status(35)
    ...
    for _, row in df.iterrows():
        # Tratamento de texto para PDF (acentos)
...
if login():
    ...
    # Menu Lateral
    st.sidebar.title("🥘 Restaurante Bem Caseiro")
    
    # AQUI ESTÁ A CORREÇÃO: ADICIONEI "📄 Relatórios PDF" DE VOLTA
    ...
    # --- ABA 7: RELATÓRIOS (RECUPERADA!) ---
    elif menu == "📄 Relatórios PDF":
        st.title("Imprimir Relatórios")
        st.write("Baixe aqui o relatório completo do estoque atual com valores financeiros.")
