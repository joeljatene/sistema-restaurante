...
# --- 1. CONFIGURAÇÃO ---
st.set_page_config(page_title="Sistema Restaurante V6.3", layout="wide", page_icon="🥘")
...
if login():
    ...
    # --- ABA 4: FICHAS TÉCNICAS ---
        ...
        with tab_conferir:
            # CORREÇÃO AQUI: Lista vertical para não quebrar no copy-paste
